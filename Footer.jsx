  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/utrialogo.svg" alt="Logo" height="100" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/mnutriaaefaludinii/"
            ...
            <li>
              <a
                href="https://www.instagram.com/utriiaa//"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/utria-efaludini-49444a206//"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 🤍 by Utria </p>
        <div className="footer--social--icon">
                </div>
      </div>
    </footer>
